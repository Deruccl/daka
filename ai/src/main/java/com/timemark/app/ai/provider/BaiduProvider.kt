 ...
 * 百度文心一言 Provider
 *
 * 简化实现：采用 OpenAI 兼容格式（百度已提供兼容接口）。
 * 默认 baseUrl: https://qianfan.baidubce.com
 */
class BaiduProvider(
    ...
    override val providerType: AIProvider = AIProvider.BAIDU

    private val defaultBaseUrl = "https://qianfan.baidubce.com"
